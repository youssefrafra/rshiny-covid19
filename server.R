  ...
  # Total Cases
    ...
    output$comparison_plot <- renderPlotly({
      ...
      if(input$comparison_metric == "cases"){
        ggplot() +
          geom_bar(data = ebola_cases,aes(x= "Ebola", y = somme), stat = 'identity',fill= '#c4353a') +
          ...
          geom_bar(data = WHO_COVID %>% filter(Name == "Global"), aes(x = "Covid", y = Cases_cumulative_total),stat = 'identity', fill= '#4cc936') +
      ...
      ggplot() +
        geom_bar(data = ebola_deaths, aes(x= "Ebola", y = somme), stat = 'identity',fill= '#c4353a') +
        ...
        geom_bar(data = WHO_COVID %>% filter(Name == "Global"), aes(x = "Covid", y = Deaths_cumulative_total),stat = 'identity', fill= '#4cc936') +
